...
Use the HTTPS_PROXY environment variable to set a proxy for requests to YouTube, since YouTube URLs are HTTPS. 
The proxy type is determined by the proxy URL scheme.
